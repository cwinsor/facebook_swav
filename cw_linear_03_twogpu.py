...
def main(rank, args):
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        scores = train(args, model, linear_classifier, optimizer, train_loader, epoch)
        scores_val = validate_network(args, val_loader, model, linear_classifier)
...
def train(args, model, reglog, optimizer, loader, epoch):
    """
...
def validate_network(args, val_loader, model, linear_classifier):
    batch_time = AverageMeter()
    losses = AverageMeter()
    top1 = AverageMeter()
    top5 = AverageMeter()
